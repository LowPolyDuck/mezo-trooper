...
export const MATS_AWARDS = [500, 250, 175, 80, 50, 40, 30, 20, 10, 5]

export const territories = {
  CAMP_SATOSHI: 'Camp Satoshi',
  MATS_FARMING_BASE: 'Mats Farming Base',
  MEZO_COMMAND: 'Mezo Command',
  BITCOINFI_FRONTIER: 'BitcoinFi Frontier',
}
